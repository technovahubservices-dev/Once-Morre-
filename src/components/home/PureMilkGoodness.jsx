...
export default function PureMilkGoodness() {
  return (
    <section className="relative bg-surface-white overflow-hidden">
            ...
            >
              <div className="relative mb-5">
                {category.shape === 'square' ? (
                  <div className="h-28 w-28 md:h-36 md:w-36 rounded-lg bg-surface-container-low border-2 border-regal-gold/60 p-2 transition-all duration-500 group-hover:border-regal-gold group-hover:shadow-[0_0_0_8px_rgba(196,164,132,0.15)]">
                    <img
                      src={category.image}
                      alt={category.name}
                  ...
                  <>
                    <div
                      className="h-28 w-28 md:h-36 md:w-36 rounded-full bg-cover bg-center border-2 border-regal-gold/60 transition-all duration-500 group-hover:border-regal-gold group-hover:shadow-[0_0_0_8px_rgba(196,164,132,0.15)]"
              ...
              <h3 className="font-headline-md text-headline-md text-deep-emerald group-hover:text-regal-gold transition-colors duration-300">
                {category.name}
              </h3>
              <p className="font-label-caps text-label-caps uppercase tracking-widest text-on-surface-variant mt-2 flex items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
...
function WavyBorder({ side }) {
  ...
  return (
    <svg
      className={`pointer-events-none absolute top-8 hidden h-[80%] w-12 text-regal-gold/30 md:block ${positionClass}`}
      viewBox="0 0 48 420"
      fill="none"
      aria-hidden="true"
    >
