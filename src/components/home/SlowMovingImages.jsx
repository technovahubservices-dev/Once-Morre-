...
export default function OfferTicker() {
  ...
  return (
    <div className="w-full bg-deep-emerald text-surface-white py-3 overflow-hidden">
      <div
      ...
      >
        {duplicatedOffers.map((offer, index) => (
          <span
            key={index}
            className="inline-flex items-center gap-2 mx-6 font-body-md text-sm md:text-base"
          >
            <span className="text-regal-gold">●</span>
            {offer}
          </span>
        ))}
      </div>
