          ...
          <div className="bg-surface-white border border-outline-variant rounded p-8 text-left mb-8">
            ...
            <div className="space-y-3 font-body-md text-body-md">
              <div className="flex justify-between">
                ...
                <span className="tabular-nums">₹ {orderConfirmation.subtotal?.toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-on-surface-variant">Tax</span>
                <span className="tabular-nums">₹ {orderConfirmation.tax?.toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-on-surface-variant">Delivery</span>
                <span className="tabular-nums">{orderConfirmation.shipping === 0 ? 'Free' : `₹ ${orderConfirmation.shipping?.toLocaleString()}`}</span>
              </div>
              <div className="border-t border-outline-variant pt-3 flex justify-between font-headline-md text-headline-md text-deep-emerald">
                <span>Total</span>
                <span className="tabular-nums">₹ {orderConfirmation.total?.toLocaleString()}</span>
              </div>
            </div>
