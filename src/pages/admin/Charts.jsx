    ...
    return (
      <div className="p-6 md:p-10">
        ...
        <div className="space-y-6">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="bg-surface-white border border-outline-variant rounded p-6 animate-pulse">
  ...
  return (
    <div className="p-6 md:p-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Orders by Status */}
        <div className="bg-surface-white border border-outline-variant rounded p-6 shadow-sm">
        ...
        {/* Stock Overview */}
        <div className="bg-surface-white border border-outline-variant rounded p-6 shadow-sm lg:col-span-2">
