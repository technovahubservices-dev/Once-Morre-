    ...
    return (
      <div className="p-6 md:p-10">
        ...
        <div className="space-y-4">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="bg-surface-white border border-outline-variant rounded p-4 animate-pulse">
    ...
    <div className="p-6 md:p-10">
        ...
        <button
          ...
          className={`px-4 py-2 rounded font-body-md text-sm transition-colors ${
            tab === 'all'
              ...
              : 'bg-surface-white border border-outline-variant text-on-surface-variant hover:text-deep-emerald'
          }`}
        >
      ...
      {adjustModalOpen && adjustingItem && (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
          <div className="bg-surface-white rounded shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <div className="flex items-center gap-4 mb-6 p-4 bg-surface-container-low rounded-lg">
                <div className="w-12 h-12 bg-surface-white rounded overflow-hidden border border-outline-variant/30 flex-shrink-0">
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
          <div className="bg-surface-white rounded shadow-xl w-full max-w-lg">
            <div className="p-6 border-b border-outline-variant flex items-center justify-between">
