                        ...
                        <div className="absolute top-1 right-1 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          {index !== 0 && (
                            <button
                              ...
                              className="p-1 bg-surface-white/90 rounded text-deep-emerald hover:bg-surface-white"
                          ...
                          <button
                            ...
                            className="p-1 bg-surface-white/90 rounded text-error hover:bg-surface-white"
                            title="Remove image"
                          >
