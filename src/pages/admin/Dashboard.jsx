  ...
  return (
    <div className="p-margin-mobile md:p-margin-desktop">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-gutter mb-stack-lg">
        {/* Total Revenue */}
        <div className="bg-surface-container-lowest rounded-xl p-6 shadow-soft transition-all relative overflow-hidden group">
        ...
        {/* Pending Orders */}
        <div className="bg-surface-container-lowest rounded-xl p-6 shadow-soft transition-all relative overflow-hidden group border-l-4 border-error">
          <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
