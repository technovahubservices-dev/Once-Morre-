...
export default function ProductDetail() {
  ...
  useEffect(() => {
    api.getProductById(Number(id)).then(setProduct)
  }, [id])
        ...
        <div className="md:col-span-5 flex flex-col justify-center px-2 md:px-6 py-4 md:py-0">
          ...
          <div className="mb-8">
            <div className="flex items-baseline gap-4">
              ...
              <span className="text-3xl font-headline-md text-primary tabular-nums tracking-tight">₹ {product.price.toLocaleString()}</span>
              {product.originalPrice && (
                <>
                  <span className="text-lg text-on-surface-variant line-through">₹ {product.originalPrice.toLocaleString()}</span>
